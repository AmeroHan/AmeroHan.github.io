...
这不是唯一的解决方式，但总得选一个（实际上后来也有编辑者用其他方式解决了单个条目中的问题[^solve]）。萌百当时的产品经理黑卡回复到：
...
[^solve]: [温迪，版本6765575与6717273间的差异](https://zh.moegirl.org.cn/index.php?diff=6765575&oldid=6717273)
